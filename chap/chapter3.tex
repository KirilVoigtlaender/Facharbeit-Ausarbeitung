...
Dies bedeutet, dass der \lstinline$Ergebnisvektor$, welcher zu Beginn auf\lstinline$bildschirmabstand$ als x- Koordinate, $0$ als y-Koordinate und 0 als z-Koordinate gesetzt ist, erst die Formel \ref{eq:v} benutzt wird und addiert wird.
