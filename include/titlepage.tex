...
\begin{titlepage}
    ...
    \begin{textblock}{10}[0,0](4.5,2.3)
         \includegraphics[width=.25\textwidth]{include/Logo.pdf}
    \end{textblock}
   ...
   % \huge(\thesisentopic)\\
    ...
    \vspace*{1.5cm}
    \includegraphics[scale=0.31]{./include/Deckbild.pdf}\\
    ...
    \begin{center}
        ...
        \iflanguage{english}{Reviewer}{Fachlehrer}: 
